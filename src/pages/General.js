...
export default function DenseAppBar() {
  ...
  return (
    ...
    <Grid 
        ...
        alignItems="center">
        <Grid item>
            <Typography variant="h4"  component="h4" color="secondary" sx={{mt:"2rem", fontWeight:"bold", textAlign: 'center', mb:"2.5rem"}}>General Commands</Typography>
        </Grid>
        <Grid item>
        ...
        <Grid item sx={{pb: '0.5rem'}}>
          <Typography variant="subtitle2" component="h4" color="primary" sx={{fontWeight:"light", mt:"2.5rem", pb:"0.5rem"}}>All general commands will have their own "/" header.</Typography>
